...
function TodosList() {
    ...
    async function handleUpdate(e, id, updatedText) {
        ...
        try {
            ...
            await axios.put("https://13.61.230.228/api", { todo_id: id, task: updatedText });
    ...
    async function handleDelete(e, id) {
        ...
        try {
            ...
            const response = await axios.delete("https://13.61.230.228/api", { data: { todo_id: id } });
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            await axios.post("https://13.61.230.228/api", { task: text });
            await getTodos();
        } catch (err) {
    ...
    const getTodos = async function () {
        try {
            ...
            const data = await axios.get("https://13.61.230.228/api");
