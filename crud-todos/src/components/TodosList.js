...
function TodosList() {
    ...
    async function handleUpdate(e, id, updatedText) {
        ...
        try {
            ...
            await axios.put("http://13.61.122.171:8080/api/todos", { todo_id: id, task: updatedText });
    ...
    async function handleDelete(e, id) {
        ...
        try {
            ...
            const response = await axios.delete("http://13.61.122.171:8080/api/todos", { data: { todo_id: id } });
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            await axios.post("http://13.61.122.171:8080/api/todos", { task: text });
            await getTodos();
        } catch (err) {
    ...
    const getTodos = async function () {
        try {
            ...
            const data = await axios.get("http://13.61.122.171:8080/api/todos");
